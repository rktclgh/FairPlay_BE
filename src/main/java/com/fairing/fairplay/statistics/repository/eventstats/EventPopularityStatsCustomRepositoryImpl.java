...
public class EventPopularityStatsCustomRepositoryImpl implements EventPopularityStatsCustomRepository {
        ...
        private static final QEventPopularityStatistics eps = QEventPopularityStatistics.eventPopularityStatistics;
        ...
        private static final QWishlist w = QWishlist.wishlist;
        private static final QEventDetail d = QEventDetail.eventDetail;
        ...
        public TopEventsResponseDto topAggregatedPopularity(LocalDate startDate, LocalDate endDate) {
                ...
                // 공통 Where 조건
                BooleanExpression dateCondition = eps.calculatedAt.goe(startDate.atStartOfDay())
                                .and(eps.calculatedAt.lt(endDate.plusDays(1).atStartOfDay()));
        ...
        @Override
        public List<EventPopularityStatisticsListDto> searchEventWithRank(LocalDate startDate, LocalDate endDate,
        ...
        public List<EventGenderPopularityDto> topMalesPick() {
                ...
                return top5.stream()
                                .map(tuple -> new EventGenderPopularityDto(
        ...
        @Override
        public List<EventAgePopularityDto> topAgePick(int age) {
                List<Tuple> results = queryFactory
                                .select(
                                                eps.eventTitle.max(),
                                                eps.count())
                ...
                return results.stream()
                                .map(tuple -> new EventAgePopularityDto(
                                                tuple.get(0, String.class),
                                                tuple.get(1, Long.class)))
                                .collect(Collectors.toList());
        }
